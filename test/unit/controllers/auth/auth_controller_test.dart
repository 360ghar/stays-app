...
void main() {
  ...
  group('FormValidationController', () {
    ...
    test('should validate email format correctly', () {
      final result = validationController.validateEmailOrPhone(
        'test@example.com',
      );
    ...
    test('should validate password length', () {
      ...
      final validPassword = validationController.validatePassword(
        'password123',
      );
    ...
    test('should validate confirm password matches', () {
      final mismatch = validationController.validateConfirmPassword(
        'pass1',
        'pass2',
      );
